...
public class AppMoneyRecall {
     ...
     * 电度电费
     */
    @Column(name = "VOLUME_CHARGE")
    private BigDecimal volumeCharge;

    /**
     * 基本电费
     */
    @Column(name = "BASIC_MONEY")
    private BigDecimal basicMoney;

    /**
     * 力调电费
     */
    @Column(name = "POWER_RATE_MONEY")
